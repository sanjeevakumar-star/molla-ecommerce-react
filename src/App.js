...
import Orderplace from "./background/orderplace";

// import RecentimageProducts from "./background/Recentimageproducts";
      ...
      <Router>
        <Switch>
          <div>
            ...
            {/* <Route path="/system/:id" component={RecentimageProducts} /> */}
